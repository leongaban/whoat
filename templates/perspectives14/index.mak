...
<%block name="body">
	<script type='text/javascript' src="/static/3rdparty/perspectives14/js/prespectives14-min.js"></script>
	...
	<div class="landing_container">
		...
		<div class="container">
		    <section class="hero">
		    	<div class="genband_logo"></div>

		    	<h1>The PERSPECTIVES14 Networking Group</h1>

		    	<p>
		    		GENDBAND has teamed up with Who@ to bring attendees a new way of helping each other. The <em>PERSPECTIVES14 Networking Group</em> allows attendees to share who they know in a private way. This allows you to search for introductions to get the deal you’ve always wanted. To get started, please use the guide below.
		    	</p>
		    </section>
		</div>
	    ...
	    <section class="call_to_action">
	    	<div class="call_to_action_content">
		    	...
		    	<div class="call_to_action_right">
		    		<p>
		    			Use the <em>PERSPECTIVES14 Networking Group</em> code <em>&#8220;#GBP14&#8221;</em> to allow those affiliated with a common purpose to pool their contacts into a search able database to help fellow group memebers.
		    		</p>
		    	</div>
	    	</div>
	    </section>
