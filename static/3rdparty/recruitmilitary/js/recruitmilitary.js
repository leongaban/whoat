$(function() {
    ...
    $('.iphone_button').unbind('click').bind('click', function () {
        window.location = 'https://s3.amazonaws.com/whoat_docs/WhoAt+Intro+Getting+Started-RM-Groups+Version.pdf';
    });
    ...
    $('.browser_button').unbind('click').bind('click', function () {
        window.location = 'https://s3.amazonaws.com/whoat_docs/WhoAt+Intro+Getting+Started-RM-Groups-Web.pdf';
    });
